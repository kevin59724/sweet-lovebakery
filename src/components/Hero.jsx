...
export default function Hero() {
    ...
    const headWords = ['Cada', 'bocado,', 'una', 'historia'];
    const dramaWord = 'dulce.';
    ...
    return (
        <section ref={heroRef} style={{
            ...
            <div style={{
                ...
                background: 'radial-gradient(circle, rgba(221,67,95,0.12) 0%, transparent 70%)',
            ...
            {[
                ...
                <span key={i} ref={el => doodlesRef.current[i] = el}
                    style={{
                        position: 'absolute', userSelect: 'none', pointerEvents: 'none',
                        color: 'var(--accent)', opacity: 0.65, fontSize: d.style.fontSize,
                        ...d.style
                    }}>
            ...
            {/* Dot pattern bg */}
            <div className="doodle-dots" style={{
            ...
            <div className="section-container" style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    <h1 ref={headRef} style={{
                        ...
                        <br />
                        <span className="word font-drama" style={{
                    ...
                    <p ref={subRef} style={{
                        ...
                        color: 'var(--text)', maxWidth: '420px',
                        marginTop: '1.4rem', marginBottom: '2.4rem',
                        opacity: 0.88,
                    }}>
                        Postres de autor hechos a medida para tus momentos más especiales.
                        Pasteles de cumpleaños, crumble cookies, cuchareables y más —
                        pensados al detalle, entregados con cariño.
                    </p>
                    ...
                    <div ref={ctaRef} style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', alignItems: 'center' }}>
                        ...
                        <a href="#menú" style={{ textDecoration: 'none' }}>
                            <button className="btn-ghost">Ver el menú</button>
                        </a>
                    </div>
                    ...
                    <div style={{
                        ...
                        {[
                            ...
                            { num: '★ 5.0', label: 'valoración general' },
                        ].map(({ num, label }) => (
                            <div key={label}>
                                <div style={{
                                    fontFamily: 'Montserrat', fontWeight: 800,
                                    fontSize: '1.45rem', color: 'var(--primary)', lineHeight: 1
                                }}>{num}</div>
                                <div style={{
                                    fontFamily: 'Open Sans', fontSize: '0.72rem',
                                    color: 'var(--text)', opacity: 0.7, letterSpacing: '0.04em',
                                    marginTop: '0.2rem'
                                }}>{label}</div>
                            </div>
                        ))}
                ...
                <div ref={imgRef} style={{
                    ...
                    <div style={{
                        ...
                        border: '2px dashed rgba(249,186,194,0.7)',
                    ...
                    <div style={{
                        ...
                        boxShadow: '0 20px 80px rgba(221,67,95,0.22), 0 0 0 2px var(--accent)',
                        position: 'relative',
                    }}>
                        <img
                    ...
                    <div style={{
                        ...
                        boxShadow: '0 8px 30px rgba(221,67,95,0.18)',
                        border: '1px solid rgba(249,186,194,0.5)',
